...
| # | 문항 | 상태 | 제출물 |
|---|---|---|---|
| 3 | 팀 소개 (링크) | ⏳ | **이력서를 Drive 에 올리고 링크** — 사용자 |
...
| | 무엇을 |
|---|---|
| **문항 3** | 이력서 정리 → Google Drive → 「링크가 있는 모든 사용자가 볼 수 있음」 |
...
> 심사 기준 03(실현 가능성)·05(팀 역량)의 근거다. 배포된 컨트랙트와 384개 테스트가 증거다.
...
| 04 시장성 | 첫 사용자 가설 + 검증 실험 (피치덱 11장) |
| 05 팀 구성 역량 | 1인이 컨트랙트·프론트·검증기 전부 |
...
| 02 기술 완성도 | 불변식 온체인 강제 · 테스트 384개 ([TEST_RECORD.md](TEST_RECORD.md)) |
