...
컨트랙트가 강제하는 불변식은 `I1`~`I19`입니다. 이 중 15개(`I1`~`I3`, `I5`~`I14`, `I16`, `I17`)는
코드에 번호 주석이 붙어 있고, `I4`·`I15`·`I18`·`I19` 는 주석 없이 검사만 있습니다.
전체 목록은 [불변식 전체 목록](../../gitbook/appendix/invariant-list.md)에 있습니다.
