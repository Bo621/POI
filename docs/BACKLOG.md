...
기준: `POI_TechSpec_v3.md` §12 체크리스트 + §6 불변식. 순서와 게이트는 `PLAN.md`.
...
| CT11 | `windowStart` 과거 | `WindowInPast` (I4) |
| CT12 | `graceSeconds` < 1시간 또는 > 30일 | `GraceOutOfRange` (I6c) |
| CT13 | 타인 노트를 승격 원본으로 | `NoteNotSameActor` (I3b) |
| CT14 | 화이트리스트 밖 지표 | `MetricNotAllowed` (I5) |
| CT15 | `refUID ≠ decisionUID` | `RefUIDMismatch` (I12) |
