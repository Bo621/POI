...
![결정 상세 화면. 등록완료 인장, 커밋 시각, 커밋 당시 선언한 조건 「> 90000000」과 관측 구간, 그리고 결과 등록에 관측값 91020000 과 출처 upbit-1m-candles 가 보인다.](assets/screen-decision-settled.png)

**한 화면에 전 과정이 있습니다.** 커밋 시각, 그때 선언한 조건(`> 90,000,000`)과 관측 구간,
그리고 구간이 끝난 뒤 등록된 관측값(`91,020,000`)과 출처.
**맞았는지는 발행자가 적는 것이 아니라 컨트랙트가 계산합니다.**

지금 체인에 있는 기록입니다 — 결정 `0xe7fe5923…fc2da0` · 정산 `0x29da3820…69cb8d`.
[지갑 없이 직접 열어](https://poi-static-production.up.railway.app) 볼 수 있습니다.
...
안 하는 이유는 둘로 나뉩니다 — 하나는 제도, 하나는 설계입니다.

### 제도상 할 수 없는 것

| 안 하는 것 | 왜 |
|---|---|
| 종목 추천 · 실시간 투자전략 제공 | **투자자문업 등록**이 필요합니다. 2024 년 자본시장법 개정으로 온라인 양방향 유료 리딩방은 등록 투자자문업자만 운영할 수 있습니다 |
| 자동매매 · 카피트레이딩 | **투자일임업 등록**이 필요합니다. 금융당국은 카피트레이딩·AI 자동매매를 전형적 위법 유형으로 안내하고 있습니다 |
| 투자금 모집 | 집합투자업·유사수신 영역입니다 |

무등록으로 투자자문업이나 투자일임업을 하면 **3년 이하 징역 또는 1억 원 이하 벌금**입니다.
POI 는 등록 금융투자업자가 아닙니다. 그래서 이 영역에 들어가지 않습니다.

> **POI 를 쓰는 사람의 의무는 그대로입니다.** POI 는 기록 인프라이고 판단은 사용자가 합니다.
> 유료로 자문을 한다면 그 사람의 등록·신고 의무는 POI 와 무관하게 남습니다.

> **출처** — [불법 금융투자업 신고센터 (금융투자협회)](https://www.kofia.or.kr/wpge/m_166/sub04070101.do) ·
> [유사투자자문업자 관리·감독 강화방안 (금융위원회)](https://www.fsc.go.kr/no010101/75847)

### 설계로 배제한 것

| 안 하는 것 | 왜 |
|---|---|
| 성과 랭킹 · 리더보드 | **완전성을 보장하지 못하기 때문입니다.** 좋은 판단만 골라 기록해도 막을 수 없는데, 그 위에 순위를 세우면 순위 자체가 거짓말이 됩니다 |
| 수익률 공개 · 판단 품질 점수 | 같은 이유입니다. 점수는 기록의 완전성을 전제하는데 그 전제가 없습니다 |
| 배지 개수 정렬·비교 UI | 개수도 사실상 점수로 작동합니다. 그래서 화면에서 세지 않습니다 |

한계는 [하지 못한 것](limits/not-yet.md)과 [신뢰 경계](problem/trust-boundary.md)에 적어 두었습니다.
