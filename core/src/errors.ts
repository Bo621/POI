...
export const RESOLVER_ERROR_MESSAGES: Record<string, string> = {
    ...
    DecisionNotFound: "정산할 결정을 찾을 수 없습니다. 존재하는 결정 UID를 확인해 주세요.",
    DecisionWrongSchema: "정산 대상의 스키마가 올바르지 않습니다. 결정 스키마의 UID를 사용해 주세요.",
    NotDecisionOwner: "결정 작성자만 정산할 수 있습니다. 결정을 작성한 계정으로 다시 시도해 주세요.",
    DecisionRevoked: "철회된 결정은 정산할 수 없습니다. 활성 상태인 결정을 선택해 주세요.",
    DecisionHasNoOutcome: "결과 판정이 없는 결정은 정산할 수 없습니다. 결과 조건이 있는 결정을 선택해 주세요.",
    WindowNotEnded: "관측 구간이 아직 끝나지 않았습니다. 종료 시각 이후에 정산해 주세요.",
    ...
    PriorStillActive: "이전 정산이 아직 활성 상태입니다. 먼저 이전 정산을 철회해 주세요.",
    SupersedesNotLastHead: "supersedes가 마지막 정산을 가리키지 않습니다. 가장 최근 정산 UID를 넣어 주세요.",
    SupersedesWrongSchema: "정정 대상의 스키마가 올바르지 않습니다. 정산 스키마의 UID를 사용해 주세요.",
    SupersedesNotRevoked: "정정 대상 정산이 철회되지 않았습니다. 먼저 해당 정산을 철회해 주세요.",
    SettlementNotFound: "이의를 제기할 정산을 찾을 수 없습니다. 존재하는 정산 UID를 확인해 주세요.",
    SettlementWrongSchema: "이의 대상의 스키마가 올바르지 않습니다. 정산 스키마의 UID를 사용해 주세요.",
    SettlementRevoked: "철회된 정산에는 이의를 제기할 수 없습니다. 활성 상태인 정산을 선택해 주세요.",
